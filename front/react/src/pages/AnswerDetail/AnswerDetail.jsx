...
const AnswerDetail = () =>{
    ...
    question.pictures.map(quesItem =>(
        answer.map(ansItem => (
            (ansItem.picture_id === quesItem.picture_id) && (
    ...
    return (
        <div className={style.container}>
            ...
            <div style={{display:'flex'}}>
                ...
                <ImageList cols={3} gap={0} sx={{border: '3px solid #545454', borderRadius: '10px', width:'70%', margin:'auto', boxShadow: '0 0 25px 0 rgba(0, 0, 0, .3)', backgroundColor: '#fff'}}>
                {answer.map((item) => (
                    <ImageListItem className={style.imgListItem} key={item.img} sx={{margin: '0 0 -1px -1px'}} >
                        ...
                        <ImageListItemBar position="below" title={item.character_name} sx={{borderBottom: '1px solid #545454', borderTop: '1px solid #545454'}}/>
                        <ImageListItemBar position="below" title={item.character_explanation} sx={{borderBottom: '1px solid #545454'}}/>
                    </ImageListItem>
                ))}
                </ImageList>
