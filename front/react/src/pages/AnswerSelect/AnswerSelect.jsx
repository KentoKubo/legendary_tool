...
const AnswerSelect = () => {
  ...
  return (
    <div className={style.container}>
      <button type="button" className={style.menuButton} onClick={clickMenuButton} variant="outlined">
        みりしら
      </button>
      <div className={style.bodyContent}>
        ...
        <div className={style.buttons}>
          ...
          <FlatButton
            text="はい！"
            onClick={() => clickYesButton(location.state.title, location.state.imgs, location.state.name)}
            variant="outlined"
          />
